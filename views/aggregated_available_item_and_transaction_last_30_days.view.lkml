view: aggregated_available_item_and_transaction_last_30_days {
  sql_table_name: "WORKSPACE_233686783"."aggregated_available_item_and_transaction_last_30_days"
    ;;
  drill_fields: [id]
  ...
  dimension: enabled_days {
    type: number
    sql: ${TABLE}."enabled_days" ;;
  }
  ...
  dimension: net_cogs_last_7 {
    type: number
    sql: ${TABLE}."net_COGS_last_7" ;;
  }
  ...
  dimension: packages_last_7 {
    type: number
    sql: ${TABLE}."packages_last_7" ;;
  }
