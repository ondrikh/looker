view: staging604a0ee1d21fc {
  sql_table_name: "WORKSPACE_233686783"."staging604a0ee1d21fc"
    ;;
  ...
  dimension: count_staging604a0ee1d21fc {
    type: number
    sql: ${TABLE}."count" ;;
  }
  ...
  dimension: dobropis_bonus {
    type: number
    sql: ${TABLE}."dobropis_bonus" ;;
  }
  ...
  dimension: logisticky_bonus {
    type: number
    sql: ${TABLE}."logisticky_bonus" ;;
  }

  dimension: marketingovy_bonus {
    type: number
    sql: ${TABLE}."marketingovy_bonus" ;;
  }
  ...
  dimension: obratovy_bonus {
    type: number
    sql: ${TABLE}."obratovy_bonus" ;;
  }
  ...
  set: detail {
    fields: [
      supplier_name,
      picking_item.supplier_name,
      picking_item.picking_item_id,
