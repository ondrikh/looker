view: out_warehouse_reallocation {
  sql_table_name: "WORKSPACE_233686783"."out_warehouse_reallocation"
    ;;
  ...
  measure: count {
    type: count
    drill_fields: [procees_group_name, application_name, process_name, activity_name]
  }
}
