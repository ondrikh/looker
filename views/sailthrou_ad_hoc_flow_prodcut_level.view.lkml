view: sailthrou_ad_hoc_flow_prodcut_level {
  sql_table_name: "WORKSPACE_233686783"."sailthrou_AdHoc_Flow_prodcut_level"
    ;;
  ...
  dimension: count_sailthrou_ad_hoc_flow_prodcut_level {
    type: string
    sql: ${TABLE}."count" ;;
  }
