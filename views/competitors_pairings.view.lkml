view: competitors_pairings {
  sql_table_name: "WORKSPACE_233686783"."competitors_pairings"
    ;;
  ...
  measure: count {
    type: count
    drill_fields: [product_name, l3_category_name, competitor_product_name, l2_category_name, l1_category_name]
  }
}
