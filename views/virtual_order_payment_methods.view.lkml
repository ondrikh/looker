view: virtual_order_payment_methods {
  sql_table_name: "WORKSPACE_233686783"."virtual_order_payment_methods"
    ;;
  ...
  dimension: adyen_payment_attribute_id {
    type: string
    sql: ${TABLE}."adyen_payment_attribute_id" ;;
  }
  ...
  dimension_group: method_changed {
    type: time
    timeframes: [
      raw,
      time,
  ...
  dimension: virtual_order_payment_id {
    type: string
    sql: ${TABLE}."virtual_order_payment_id" ;;
  }
