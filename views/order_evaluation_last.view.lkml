view: order_evaluation_last {
  sql_table_name: "WORKSPACE_233686783"."order_evaluation_last"
    ;;
  drill_fields: [id]
  ...
  dimension: expiration_grade {
    type: string
    sql: ${TABLE}."Expiration grade" ;;
  }
  ...
  dimension: notification_5_min {
    type: string
    sql: ${TABLE}."Notification 5 min" ;;
  }
  ...
  dimension: order_quality_fru_vege_score {
    type: number
    sql: ${TABLE}."Order quality fru vege_score" ;;
  }
  ...
  dimension: quality_fru_vege_count_sum {
    type: number
    sql: ${TABLE}."Quality fru vege count_sum" ;;
  }
  ...
  dimension: quality_fru_vege_score_sum {
    type: number
    sql: ${TABLE}."Quality fru vege score_sum" ;;
  }
