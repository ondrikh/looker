view: batch_campaign_self_service_evaluation {
  sql_table_name: "WORKSPACE_233686783"."batch_campaign_self_service_evaluation"
    ;;
  ...
  dimension: count_batch_campaign_self_service_evaluation {
    type: string
    sql: ${TABLE}."count" ;;
  }
