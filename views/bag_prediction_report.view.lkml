view: bag_prediction_report {
  sql_table_name: "WORKSPACE_233686783"."bag_prediction_report"
    ;;
  drill_fields: [id]
  ...
  dimension: cooled_bags_old {
    type: number
    sql: ${TABLE}."cooled_bags_old" ;;
  }
  ...
  dimension: dry_bags_old {
    type: number
    sql: ${TABLE}."dry_bags_old" ;;
  }
  ...
  dimension: frozen_bags_old {
    type: number
    sql: ${TABLE}."frozen_bags_old" ;;
  }
