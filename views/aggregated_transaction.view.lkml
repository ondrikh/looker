view: aggregated_transaction {
  sql_table_name: "WORKSPACE_233686783"."aggregated_transaction"
    ;;
  ...
  dimension: lm_action_before_shrink {
    type: string
    sql: ${TABLE}."LM_action_before_shrink" ;;
  }
