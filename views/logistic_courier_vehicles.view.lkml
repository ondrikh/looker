view: logistic_courier_vehicles {
  sql_table_name: "WORKSPACE_233686783"."logistic_courier_vehicles"
    ;;
  ...
  measure: count {
    type: count
    drill_fields: [car_name, courier_name, vehicles.id, vehicles.name]
  }
}
